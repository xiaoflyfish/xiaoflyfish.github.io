...
然而随着我们的业务规模越来越大，我们的容器规模也逐渐增大时，数量庞大的容器管理将给我们带来许多挑战。
...
其实 Swarm 的优点远远不止这些，还有很多，例如以下优点。
...
<img src="https://xiaoflyfish.oss-cn-beijing.aliyuncs.com/image/20210228135521.png" style="zoom:25%;" />
...
<img src="https://xiaoflyfish.oss-cn-beijing.aliyuncs.com/image/20210228135732.png" style="zoom:25%;" />
...
想要了解更多的docker service命令的相关操作，可以[参考](https://docs.docker.com/engine/swarm/swarm-tutorial/deploy-service/)这里。
