...
![](https://xiaoflyfish.oss-cn-beijing.aliyuncs.com/image/20201219215424.png)
...
图是由一个 `list` 结构和三个 `listNode` 结构组成的链表：

![](https://xiaoflyfish.oss-cn-beijing.aliyuncs.com/image/20201219215442.png)
